...
.field private dv:Landroid/os/Bundle;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->ds:I

    const-wide/16 v0, 0xbb8

    iput-wide v0, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dt:J

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->du:[B

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dv:Landroid/os/Bundle;
    ...
    iput-object p1, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dr:Ljava/lang/String;
...
.method public build()Lcom/google/android/gms/auth/api/proxy/ProxyRequest;
    ...
    iget-object v0, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->du:[B
    ...
    iget-object v2, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dr:Ljava/lang/String;

    iget v3, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->ds:I

    iget-wide v4, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dt:J

    iget-object v6, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->du:[B

    iget-object v7, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dv:Landroid/os/Bundle;
...
.method public putHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dv:Landroid/os/Bundle;
...
.method public setBody([B)Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;
    ...
    iput-object p1, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->du:[B
...
.method public setHttpMethod(I)Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;
    ...
    iput p1, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->ds:I
...
.method public setTimeoutMillis(J)Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;
    ...
    iput-wide p1, p0, Lcom/google/android/gms/auth/api/proxy/ProxyRequest$Builder;->dt:J
