...
.field private final Yy:Landroid/os/Bundle;
...
.method constructor <init>(IFFIIIFFLandroid/os/Bundle;FFF)V
    ...
    iput p2, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yr:F

    iput p3, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Ys:F

    iput p4, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yt:I

    iput p5, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yu:I

    iput p6, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yv:I

    iput p7, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yw:F

    iput p8, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yx:F

    iput-object p9, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yy:Landroid/os/Bundle;

    iput p10, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yz:F

    iput p11, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->YA:F

    iput p12, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->YB:F
...
.method public constructor <init>(Lcom/google/android/gms/games/stats/PlayerStats;)V
    ...
    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yr:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getChurnProbability()F

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Ys:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getDaysSinceLastPlayed()I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yt:I

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getNumberOfPurchases()I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yu:I

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getNumberOfSessions()I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yv:I

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getSessionPercentile()F

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yw:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getSpendPercentile()F

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yx:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getSpendProbability()F

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yz:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getHighSpenderProbability()F

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->YA:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->getTotalSpendNext28Days()F

    move-result v0

    iput v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->YB:F

    invoke-interface {p1}, Lcom/google/android/gms/games/stats/PlayerStats;->zzbkq()Landroid/os/Bundle;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yy:Landroid/os/Bundle;
...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->zzbkr()Lcom/google/android/gms/games/stats/PlayerStats;
...
.method public getAverageSessionLength()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yr:F
...
.method public getChurnProbability()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Ys:F
...
.method public getDaysSinceLastPlayed()I
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yt:I
...
.method public getHighSpenderProbability()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->YA:F
...
.method public getNumberOfPurchases()I
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yu:I
...
.method public getNumberOfSessions()I
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yv:I
...
.method public getSessionPercentile()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yw:F
...
.method public getSpendPercentile()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yx:F
...
.method public getSpendProbability()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yz:F
...
.method public getTotalSpendNext28Days()F
    ...
    iget v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->YB:F
...
.method public zzbkq()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/google/android/gms/games/stats/PlayerStatsEntity;->Yy:Landroid/os/Bundle;
