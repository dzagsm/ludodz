...
.method public zza(Landroid/content/Context;Ljava/util/Map;)Landroid/content/Intent;
    ...
    invoke-virtual {v3, v4, v1}, Lcom/google/android/gms/internal/zzkh;->zza(Lcom/google/android/gms/internal/zzlh;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v3, v6}, Lcom/google/android/gms/internal/zzew$zza;->zza(Landroid/content/Context;Landroid/content/Intent;Ljava/util/ArrayList;)Landroid/content/pm/ResolveInfo;

    move-result-object v2

    if-eqz v2, :cond_4

    invoke-virtual {p0, v3, v2}, Lcom/google/android/gms/internal/zzew$zza;->zza(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1, v1}, Lcom/google/android/gms/internal/zzew$zza;->zza(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/pm/ResolveInfo;

    move-result-object v1

    if-eqz v1, :cond_5

    invoke-virtual {p0, v3, v1}, Lcom/google/android/gms/internal/zzew$zza;->zza(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;)Landroid/content/Intent;

    move-result-object v2

    invoke-virtual {p0, p1, v2}, Lcom/google/android/gms/internal/zzew$zza;->zza(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {p0, v3, v0}, Lcom/google/android/gms/internal/zzew$zza;->zza(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;)Landroid/content/Intent;
