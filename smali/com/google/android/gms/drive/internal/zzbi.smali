...
# instance fields
.field private final Hm:Lcom/google/android/gms/drive/DriveFile$DownloadProgressListener;
...
# direct methods
.method constructor <init>(Lcom/google/android/gms/internal/zzpm$zzb;Lcom/google/android/gms/drive/DriveFile$DownloadProgressListener;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/android/gms/drive/internal/zzbi;->zv:Lcom/google/android/gms/internal/zzpm$zzb;

    iput-object p2, p0, Lcom/google/android/gms/drive/internal/zzbi;->Hm:Lcom/google/android/gms/drive/DriveFile$DownloadProgressListener;
...
.method public onError(Lcom/google/android/gms/common/api/Status;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/internal/zzbi;->zv:Lcom/google/android/gms/internal/zzpm$zzb;
...
.method public zza(Lcom/google/android/gms/drive/internal/OnContentsResponse;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/drive/internal/OnContentsResponse;->zzbak()Z
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/android/gms/drive/internal/zzbi;->zv:Lcom/google/android/gms/internal/zzpm$zzb;

    new-instance v2, Lcom/google/android/gms/drive/internal/zzs$zzb;

    new-instance v3, Lcom/google/android/gms/drive/internal/zzv;

    invoke-virtual {p1}, Lcom/google/android/gms/drive/internal/OnContentsResponse;->zzbaj()Lcom/google/android/gms/drive/Contents;
...
.method public zza(Lcom/google/android/gms/drive/internal/OnDownloadProgressResponse;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/internal/zzbi;->Hm:Lcom/google/android/gms/drive/DriveFile$DownloadProgressListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/drive/internal/zzbi;->Hm:Lcom/google/android/gms/drive/DriveFile$DownloadProgressListener;

    invoke-virtual {p1}, Lcom/google/android/gms/drive/internal/OnDownloadProgressResponse;->zzbam()J

    move-result-wide v2

    invoke-virtual {p1}, Lcom/google/android/gms/drive/internal/OnDownloadProgressResponse;->zzban()J
