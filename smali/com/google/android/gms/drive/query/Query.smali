...
.field final IQ:Lcom/google/android/gms/drive/query/internal/LogicalFilter;

.field final IR:Ljava/lang/String;

.field final IS:Lcom/google/android/gms/drive/query/SortOrder;
...
.method private constructor <init>(ILcom/google/android/gms/drive/query/internal/LogicalFilter;Ljava/lang/String;Lcom/google/android/gms/drive/query/SortOrder;Ljava/util/List;ZLjava/util/List;Ljava/util/Set;Z)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/drive/query/Query;->IQ:Lcom/google/android/gms/drive/query/internal/LogicalFilter;

    iput-object p3, p0, Lcom/google/android/gms/drive/query/Query;->IR:Ljava/lang/String;

    iput-object p4, p0, Lcom/google/android/gms/drive/query/Query;->IS:Lcom/google/android/gms/drive/query/SortOrder;

    iput-object p5, p0, Lcom/google/android/gms/drive/query/Query;->IT:Ljava/util/List;

    iput-boolean p6, p0, Lcom/google/android/gms/drive/query/Query;->IU:Z

    iput-object p7, p0, Lcom/google/android/gms/drive/query/Query;->Eu:Ljava/util/List;

    iput-object p8, p0, Lcom/google/android/gms/drive/query/Query;->Ev:Ljava/util/Set;

    iput-boolean p9, p0, Lcom/google/android/gms/drive/query/Query;->GF:Z
...
.method public getFilter()Lcom/google/android/gms/drive/query/Filter;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->IQ:Lcom/google/android/gms/drive/query/internal/LogicalFilter;
...
.method public getPageToken()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->IR:Ljava/lang/String;
...
.method public getSortOrder()Lcom/google/android/gms/drive/query/SortOrder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->IS:Lcom/google/android/gms/drive/query/SortOrder;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->IQ:Lcom/google/android/gms/drive/query/internal/LogicalFilter;

    aput-object v4, v2, v3

    const/4 v3, 0x1

    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->IS:Lcom/google/android/gms/drive/query/SortOrder;

    aput-object v4, v2, v3

    const/4 v3, 0x2

    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->IR:Ljava/lang/String;

    aput-object v4, v2, v3

    const/4 v3, 0x3

    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->Eu:Ljava/util/List;
...
.method public zzbbi()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->IT:Ljava/util/List;

    return-object v0
.end method

.method public zzbbj()Z
    .locals 1

    iget-boolean v0, p0, Lcom/google/android/gms/drive/query/Query;->IU:Z

    return v0
.end method

.method public zzbbk()Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->Ev:Ljava/util/Set;

    return-object v0
.end method

.method public zzbbl()Z
    .locals 1

    iget-boolean v0, p0, Lcom/google/android/gms/drive/query/Query;->GF:Z
